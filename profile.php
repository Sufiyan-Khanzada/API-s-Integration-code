...
<img src="<?php  echo $_SESSION['image']; ?>" class="rounded-circle" width=100 height=100>
</div>
<div>
<div>        
        ...
        <span>@glatzekatze</span></div>
                <div class="d-flex flex-row justify-content-center align-items-center gap-2">
                    <span class="idd1 st1"><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i></span><span class="idd1">(0)</span> </div>
...
<?php 
    ...
    <ul class="list-group" style="margin-top: 20px;">
        <a href="favourite.php" class="ancacc"><li class="list-group-item ">Favourites <span style="float: right;"><i class="fa fa-angle-right"></i></span></li></a>
        <a href="reviews.php" class="ancacc"><li class="list-group-item ">Reviews <span style="float: right;"><i class="fa fa-angle-right"></i></span></li></a>
        <a href="myproducts.php" class="ancacc"><li class="list-group-item ">My Products <span style="float: right;"><i class="fa fa-angle-right"></i></span></li></a>
        <a href="rented_product.php" class="ancacc"><li class="list-group-item ">Rented Products <span style="float: right;"><i class="fa fa-angle-right"></i></span></li></a>
        <a href="stats.php" class="ancacc"><li class="list-group-item ">Stats <span style="float: right;"><i class="fa fa-angle-right"></i></span></li></a>
        <a href="lender_activity.php" class="ancacc"><li class="list-group-item ">Earning <span style="float: right;"><i class="fa fa-angle-right"></i></span></li></a>
