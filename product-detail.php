    ...
    <div class="container">
        <div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
            ...
            <a href="product.php" class="stext-109 cl8 hov-cl1 trans-04">
             ...
             <a href="product.php" class="stext-109 cl8 hov-cl1 trans-04">
                <?php  echo $user_data->subcategory;?>
                <i class="fa fa-angle-right m-l-9 m-r-10" aria-hidden="true"></i>
            </a>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-5 p-b-30">
                    <div class="p-r-50 p-t-5 p-lr-0-lg">
                        <div class="heart3">
                        <div class="mtext-105 cl2 js-name-detail p-b-14">
                            <h4><?php  echo $user_data->Item_name;?></h4>
                        </div>
                        <div>
                        <a href="#" class="fs-14 cl3 hov-cl1 trans-04 lh-10 p-lr-5 p-tb-2 js-addwish-detail tooltip100" data-tooltip="Add to Wishlist">
                                    <i class="zmdi zmdi-favorite fa-2x"></i>
                                </a> 
                        </div>

                        </div>
                        <div class="head1txt"><?php  echo $user_data->Item_brand;?></div>
                                    ...
                                    <ul class="p-lr-28 p-lr-15-sm">
                                        ...
                                        <li class="flex-w flex-t p-b-7">
                                            ...
                                            <span class="stext-102 cl6 size-206">
												<img src="authenticity.png" style="width:30px;height:30px"/>
											</span>
                                        </li>
                                        ...
                                        <li class="flex-w flex-t p-b-7">
                                            ...
                                            <span class="stext-102 cl6 size-206">
                                                <a href="product3.jpg" data-lightbox="models" data-title="Product Condition">
                                                  <img src="product3.jpg" style="width:30px;height:30px"/>
                                                </a>
                                                <a href="product2.jpg" data-lightbox="models" data-title="Product Condition">
                                                  <img src="product2.jpg" style="width:30px;height:30px"/>
                                                </a>
												  
                                                </a>
                                                <a href="product5.jpg" data-lightbox="models" data-title="Product Condition">
                                                 <img src="product5.jpg" style="width:30px;height:30px"/>
                                                </a>
...
$api_url = "https://sofiapi.code7labs.com/api/single-product_cat/".$user_data->category;
                ...
                <div class="slick2">
                   ...
                   <div class="block2" style="margin-bottom: 10px;">
                            ...
                            <div class="block2-txt flex-w flex-t p-t-14" style="justify-content: center;">
                                <div class="block2-txt-child1 flex-col-l ">
                                    <a href="product-detail.php" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                                     ...
                                     <p class="card-text" ><small class="text-muted">
                                            <?php  echo $user_data->Item_brand;?>
                                        <span style="color: <?php  echo $user_data->color;?>">|</span> <span>   <?php  echo $user_data->size;?></span></small>
                                    </p>
                                </div>
                                ...
                                <div class="flex-c-m stext-106 cl6 size-104 bor4 pointer hov-btn4 trans-04 m-r-8 m-tb-4">
						            <i class="icon-close-filter cl2 m-r-6 fs-15 trans-04 zmdi zmdi-close dis-none"></i>
                                    <a href="product-detail.php" style="text-decoration: none; padding:8px; ">€ <?php  echo  $user_data->Item_price;?>/Day</a> 
					            </div>
                            </div>
                        </div>
