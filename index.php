...
.img-wish2{text-align: center !important;}
.img-wish2 img{width: 100%;} 
...
$url = $baseurlapi."showtrendingproducts";
...
foreach ($user_data1 as $user1) {
  ?>
                        ...
                        <a href='product-detail.php?id=<?php echo $user1->id; ?>'>
                            ...
                            <div class="block2-txt flex-w flex-t p-t-14" style="justify-content: center;">
                                <div class="block2-txt-child1 flex-col-l ">
                                    <a href="product-detail.php" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
										<?php echo $user1->Item_name ?>
									</a>
                                     <p class="card-text" ><small class="text-muted">
                                        <?php echo $user1->Item_brand ?>
                                        <span style="color:#C5C5C5">|</span> <span><?php echo $user1->size ?></span></small>
                                    </p>
                                </div>
                                ...
                                <div class="flex-c-m stext-106 cl6 size-104 bor4 pointer hov-btn4 trans-04 m-r-8 m-tb-4">
						            <i class="icon-close-filter cl2 m-r-6 fs-15 trans-04 zmdi zmdi-close dis-none"></i>
                                    <a href="product-detail.php" style="text-decoration: none; padding:8px; ">€<?php echo $user1->Item_price?>/Day</a> 
					            </div>
                            </div>
                        </div>
...
<div class="main">
    <div class="slider slide-show">
        <div class="block2" ">
            <div class="block2-pic hov-img0">
                <a href="product-detail.php">
                    <img src="brandslogo.png" alt="IMG-PRODUCT">
                </a>
            </div>
        </div>
        <div class="block2" ">
...
// include_once 'constant.php';
$baseurlapi="https://sofiapi.code7labs.com/api/";
$url = $baseurlapi."showbrandeduser";
...
foreach ($user_data as $user) {
  ?>
                    <div>
                        <a href='branded-user.php?id=<?php echo $user->id; ?>'><img src="<?php echo $user->profile; ?>" alt="IMG-PRODUCT"></a>
