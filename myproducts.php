        ...
        <!-- <a href="product-detail.php"> -->
          <div class="card" style="width: 100%; border:none;">
                                ...
                                <div class="card-body" style="padding: 8px;">
                                 ...
                                 <small class="text-muted" >Louis Vuitton<span> |</span> <span><?php echo $user->size; ?></span></small>

                                 
                                <center>
                                 <a href="#" class="btn btn-primary bor4">€ <?php echo $user->Item_price; ?></a>
                                  </center>
                                </div>
                              </div></a>
